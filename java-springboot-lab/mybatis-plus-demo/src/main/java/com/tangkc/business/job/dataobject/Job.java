...
public class Job {
    ...
    public static final String COL_COID = "coid";

    public static final String COL_COMPANY_NAME = "company_name";

    public static final String COL_COMPANY_HREF = "company_href";

    public static final String COL_JOB_NAME = "job_name";

    public static final String COL_JOB_TITLE = "job_title";

    public static final String COL_JOB_HREF = "job_href";

    public static final String COL_PROVIDE_SALARY = "provide_salary";

    public static final String COL_COMPANY_TYPE = "company_type";

    public static final String COL_COMPANY_SIZE = "company_size";

    public static final String COL_JOB_WELF = "job_welf";

    public static final String COL_JOB_ATTRIBUTE = "job_attribute";

    public static final String COL_WORK_AREA = "work_area";

    public static final String COL_WORK_AREA_ID = "work_area_id";

    public static final String COL_WORK_AREA_NAME = "work_area_name";
